...
<body class="bg-gray-100">
    ...
    <h1 class="text-4xl font-bold text-gray-900">Música selecionado - {{$musicas->nome}}</h1>
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Tem certeza que deseja apagar essa música?</h3>
                <h4 class="mb-5  font-normal text-gray-500 dark:text-gray-400">Você apagará tudo relacionado a ela</h4>
