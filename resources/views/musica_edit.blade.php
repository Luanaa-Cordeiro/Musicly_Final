...
<div class="formulario_edit_musica">    
<div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="modal_main">
                <form class="space-y-4" action="{{ route('musicas.update', ['musica' => $musicas->id])}}" method='post'>
                @csrf
                    <div>
                        ...
                        value="{{$musicas->nome}}" type="text" id="form1Example2" name="nome" placeholder="Nome"/>
                ...
                <option value="{{ $artista->id }}" 
                        @if($artista->id == $musicas->id_artista) selected @endif>
                    {{ $artista->nome }}
                </option>
            @endforeach
                        </select>
                ...
                <option value="{{ $genero->id }}" 
                        @if($genero->id == $musicas->id_genero) selected @endif>
                    {{ $genero->nome }}
                </option>
            @endforeach
</select>
...
@foreach($albuns as $album)
                <option value="{{ $album->id }}" 
                        @if($album->id == $musicas->id_album) selected @endif>
                    {{ $album->nome }}
                </option>
            @endforeach
</select>
