...
<div class='adicionar'>
<h1 class="text-4xl font-bold text-gray-900">Músicas!</h1>
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="modal_main">
                <form class="space-y-4" action="{{ route('musicas.store')}}" method="post">
                @csrf
                    <div>
                        <label for="nome_artista" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nome da Música<span class="asterisco">*</span></label>
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        @foreach($musicas as $musica)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <a href="{{ route('musicas.edit', ['musica' => $musica->id]) }}"><button id="editar">Editar</button></a>
                <a href="{{route('musicas.show',['musica' => $musica->id])}}"><button id="deletar">Mostrar</button></a>
                </td>
