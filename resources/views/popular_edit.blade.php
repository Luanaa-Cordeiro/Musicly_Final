            ...
            <nav id="sidebar"
                ...
                <div class="px-4 pb-6">
                    ...
                    <ul class="mb-8 text-sm font-medium">
                        ...
                        <li>
                            <a href="{{route('populars.index')}}" class="active flex items-center rounded py-3 pl-3 pr-4 text-gray-50 hover:bg-gray-600"
                                href="#link1">
