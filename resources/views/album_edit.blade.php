...
<div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="modal_main">
                <form class="space-y-4" action="{{ route('albuns.update', ['album' => $albuns->id])}}" method='post'>
                @csrf
                    <div>
                        ...
                        value="{{$albuns->nome}}" type="text" id="form1Example2" name="nome" placeholder="Nome"/>
                ...
                <option value="{{ $artista->id }}" 
                        @if($artista->id == $albuns->id_artista) selected @endif>
                    {{ $artista->nome }}
                </option>
            @endforeach
                        </select>
