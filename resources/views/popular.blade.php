...
<div class='adicionar'>
<h1 class="text-4xl font-bold text-gray-900">Populares!</h1>
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
                ...
                <th scope="col" style="background-color:#6d7fcc; color:white;">Música</th>
                <th scope="col" class="px-6 py-3" style="background-color:#6d7fcc; color:white;">Artista</th>
                <th scope="col" class="px-6 py-3" style="background-color:#6d7fcc; color:white;">Álbum</th>
                      <th style="background-color:#6d7fcc; color:white;">Gênero</th>
                <th scope="col" class="px-6 py-3" scope="col" class="px-6 py-3" style="background-color:#6d7fcc; color:white;" id='ação'>Ações</th>
        ...
        @foreach($populars as $popular)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <a href="{{ route('populars.edit', ['popular' => $popular->id]) }}"><button id="editar">Editar</button></a>
                <a href="{{route('populars.show',['popular' => $popular->id])}}"><button id="deletar">Mostrar</button></a>
                </td>
